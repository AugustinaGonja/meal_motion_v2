...
class UserProfile(models.Model):
    ...
    default_country = CountryField(blank_label = 'Select a Country', max_length=40, null =True , blank =True)
    ...
    default_address_line_2 = models.CharField(max_length=255, null=True, blank=True)
